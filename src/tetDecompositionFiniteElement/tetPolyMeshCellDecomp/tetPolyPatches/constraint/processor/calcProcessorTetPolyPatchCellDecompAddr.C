...
void processorTetPolyPatchCellDecomp::calcCutEdgeIndices() const
{
    if (debug)
    {
        Info<< "void processorTetPolyPatchCellDecomp::"
    ...
    if (cutEdgeIndicesPtr_)
    {
        FatalErrorIn
        (
            "void processorTetPolyPatchCellDecomp::calcCutEdgesIndices() const"
...
void processorTetPolyPatchCellDecomp::calcCutEdgeAddressing() const
{
    if
    (
    ...
    )
    {
        FatalErrorIn
        (
            "void processorTetPolyPatchCellDecomp::calcCutEdgeAddressing() "
            "const"
        )   << "addressing already allocated"
            << abort(FatalError);
    }
...
void processorTetPolyPatchCellDecomp::calcOwnNeiDoubleMask() const
{
    if (ownNeiDoubleMaskPtr_)
    {
        FatalErrorIn
        (
            "void processorTetPolyPatchCellDecomp::calcOwnNeiDoubleMask() "
            "const"
...
const labelList& processorTetPolyPatchCellDecomp::localEdgeIndices() const
{
    if (!localEdgeIndicesPtr_)
    {
        ...
        else
        {
            ...
            // To adhere to the interface, the primitive patch is created
            // from master faces locally and lost after use
            localEdgeIndicesPtr_ =
                new labelList
                (
...
const labelList& processorTetPolyPatchCellDecomp::cutEdgeIndices() const
{
    if (!cutEdgeIndicesPtr_)
    {
        calcCutEdgeIndices();
...
const labelList& processorTetPolyPatchCellDecomp::cutEdgeOwnerIndices() const
{
...
const labelList& processorTetPolyPatchCellDecomp::cutEdgeOwnerStart() const
{
...
const labelList&
processorTetPolyPatchCellDecomp::cutEdgeNeighbourIndices() const
{
...
const labelList& processorTetPolyPatchCellDecomp::cutEdgeNeighbourStart() const
{
...
const labelList& processorTetPolyPatchCellDecomp::doubleCutEdgeIndices() const
{
...
const labelList& processorTetPolyPatchCellDecomp::doubleCutOwner() const
{
...
const labelList& processorTetPolyPatchCellDecomp::doubleCutNeighbour() const
{
...
const scalarField& processorTetPolyPatchCellDecomp::ownNeiDoubleMask() const
{
    if (!ownNeiDoubleMaskPtr_)
    {
