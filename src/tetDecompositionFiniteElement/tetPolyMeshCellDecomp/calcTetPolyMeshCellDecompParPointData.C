...
void Foam::tetPolyMeshCellDecomp::calcParPointData() const
{
    if (!Pstream::parRun())
    {
...
void Foam::tetPolyMeshCellDecomp::clearOutParPointData() const
{
...
const labelList& Foam::tetPolyMeshCellDecomp::parallelPoints() const
{
    if (!parPointsPtr_)
    {
        calcParPointData();
...
const edgeList& Foam::tetPolyMeshCellDecomp::parallelEdges() const
{
    if (!parEdgesPtr_)
    {
        calcParPointData();
