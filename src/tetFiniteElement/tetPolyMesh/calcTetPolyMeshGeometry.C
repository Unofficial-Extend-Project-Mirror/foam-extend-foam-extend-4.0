...
label tetPolyMesh::nPoints() const
{
    if (nPoints_ < 0)
    {
        nPoints_ =
...
label tetPolyMesh::nEdges() const
{
    if (nEdges_ < 0)
    {
...
cellShapeList tetPolyMesh::tetCells() const
{
...
void tetPolyMesh::gradNiDotGradNj
(
    const label cellID,
