...
namespace Foam
{
    ...
    addToRunTimeSelectionTable(rheologyLaw, orthotropicLinearElastic, dictionary);
}
...
Foam::scalar Foam::orthotropicLinearElastic::sigmaY(const scalar epsilonPEq, const label cellID) const
{
  return GREAT;
}
