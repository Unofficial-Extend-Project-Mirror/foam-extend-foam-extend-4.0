...
#include "largeStrainULSolidInterface.H"
...
namespace Foam
{
    defineTypeNameAndDebug(largeStrainULSolidInterface, 0);
    addToRunTimeSelectionTable(solidInterface, largeStrainULSolidInterface, dictionary);
}
...
Foam::largeStrainULSolidInterface::largeStrainULSolidInterface
(
 const word& name,
 const fvMesh& mesh,
...
void Foam::largeStrainULSolidInterface::correct(fvVectorMatrix& UEqn)
{
