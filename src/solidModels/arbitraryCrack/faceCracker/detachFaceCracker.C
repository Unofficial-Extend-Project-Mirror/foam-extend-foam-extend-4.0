...
// Pout << "addedPoints before point creation: " << addedPoints << endl;
    ...
    // forAll(mf, faceI)
    // {
    //     const labelList& curMasterFacePoints = faces[mf[faceI]];
    //     const labelList& curMasterFaceEdges = faceEdges[mf[faceI]];
    //     const labelList& curMasterCellEdges = faceEdges[mc[faceI]];

    //     labelHashSet masterCellEdges;
    ...
    //         {
    //             bool belongToMasterCell = false;

    //             forAll(curMasterCellEdges, eI)
    //             {
    //                 if (curMasterCellEdges[eI] == curPointEdges[edgeI])
    //                 {
    //                     belongToMasterCell = true;
    //                     break;
    //                 }
    //             }

    //             if (belongToMasterCell)
    //             {
    //                 bool belongToMasterFace = false;

    //                 forAll(curMasterFaceEdges, eI)
    //                 {
    //                     if (curMasterFaceEdges[eI] == curPointEdges[edgeI])
    //                     {
    //                         belongToMasterFace = true;
    //                         break;
    //                     }
    //                 }

    //                 if (!belongToMasterFace)
    //                 {
    //                     masterCellEdges.insert(curPointEdges[edgeI]);
    //                 }
    //             }
    //         }
    //     }

    //     labelList mcEdges = masterCellEdges.toc();

    //     labelHashSet masterCellCells;
    ...
    //             {
    //                 if (!masterCellCells.found(curEdgeCells[cellI]))
    //                 {
    //                     masterCellCells.insert(curEdgeCells[cellI]);
    //                 }
    //             }
    //         }
    //     }
    ...
    //     {
    //         const labelList& curFaces = cells[mcCells[cellI]];
