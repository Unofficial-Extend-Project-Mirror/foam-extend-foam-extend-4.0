...
Foam::BlockMatrixReorderedClustering<Type>::weightFactor_
(
    "aamgWeightFactor",
    0.65
);
...
template<class Type>
const Foam::debug::tolerancesSwitch
Foam::BlockMatrixReorderedClustering<Type>::diagFactor_
(
    "aamgDiagFactor",
    1e-8
);
...
template<class Type>
void Foam::BlockMatrixReorderedClustering<Type>::calcClustering()
{
    if (matrix_.diagonal())
    {
    ...
    PriorityList<scalar> cardinality(nCoarseEqns_);
...
template<class Type>
void Foam::BlockMatrixReorderedClustering<Type>::restrictDiag
(
...
) const
{
    ...
    else
    {
        FatalErrorIn
        (
            "void  BlockMatrixReorderedClustering<Type>::restrictDiag() const"
...
void Foam::BlockMatrixReorderedClustering<Type>::agglomerateCoeffs
(
...
template<class Type>
void Foam::BlockMatrixReorderedClustering<Type>::restrictDiagDecoupled
(
    const CoeffField<Type>& Coeff,
    CoeffField<Type>& coarseCoeff
) const
{
    ...
    else
    {
        FatalErrorIn
        (
            "void BlockMatrixReorderedClustering<Type>::restrictDiagDecoupled()"
            " const"
        )   << "Problem in coeff type morphing"
            << abort(FatalError);
    }
...
template<class Type>
Foam::BlockMatrixReorderedClustering<Type>::BlockMatrixReorderedClustering
(
...
Foam::BlockMatrixReorderedClustering<Type>::restrictMatrix() const
{
    if (!coarsen_)
    {
        FatalErrorIn
...
template<class Type>
void Foam::BlockMatrixReorderedClustering<Type>::restrictResidual
(
...
template<class Type>
void Foam::BlockMatrixReorderedClustering<Type>::prolongateCorrection
(
    Field<Type>& x,
