...
makeFvGradScheme(venkatakrishnanGrad)
...
>
venkatakrishnanGrad<vector>::fvmGrad
(
...
) const
{
    FatalErrorIn
    (
        "tmp<BlockLduSystem> venkatakrishnanGrad<vector>::fvmGrad\n"
        "(\n"
