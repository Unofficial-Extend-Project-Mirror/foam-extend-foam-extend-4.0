...
void Foam::verticalValves::calcMovingMaskTop(const label i) const
{
    if (debug)
    {
    ...
    const labelList& cellAddr =
        cellZones()[cellZones().findZoneID("movingCellsTopV"+ Foam::name(i+1))];
...
const Foam::scalarField& Foam::verticalValves::movingPointsMaskTop(const label i) const
{
    if(movingPointsMaskTopPtr_)
    {
...
void Foam::verticalValves::calcMovingMaskBottom(const label i) const
{
    if (debug)
    {
        Info<< "void movingSquaresTM::calcMovingMasks() const : "
    ...
    const labelList& cellAddr =
        cellZones()[cellZones().findZoneID("movingCellsBotV"+ Foam::name(i+1))];
...
// Return moving points mask.  Moving points marked with 1
const Foam::scalarField& Foam::verticalValves::movingPointsMaskBottom(const label i) const
{
    if(movingPointsMaskBottomPtr_)
    {
...
void Foam::verticalValves::calcMovingMaskPiston() const
{
    if (debug)
    {
        Info<< "void movingSquaresTM::calcMovingMasks() const : "
...
// Return moving points mask.  Moving points marked with 1
const Foam::scalarField& Foam::verticalValves::movingPointsMaskPiston() const
{
    if(movingPointsMaskPistonPtr_)
    {
...
void Foam::verticalValves::calcMovingMaskPistonValves(const label i) const
{
    if (debug)
    {
        Info<< "void movingSquaresTM::calcMovingMasks() const : "
...
// Return moving points mask.  Moving points marked with 1
const Foam::scalarField& Foam::verticalValves::movingPointsMaskPistonValves(const label i) const
{
    if(movingPointsMaskPistonValvesPtr_)
    {
