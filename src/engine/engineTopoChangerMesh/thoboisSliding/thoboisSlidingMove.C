...
bool Foam::thoboisSliding::attached() const
{
...
void Foam::thoboisSliding::valveDetach()
{
    // Enable sliding interface
    forAll (topoChanger_, modI)
    {
...
void Foam::thoboisSliding::valveAttach()
{
    // Enable sliding interface
    forAll (topoChanger_, modI)
    {
...
void Foam::thoboisSliding::prepareValveDetach()
{
    // Enable sliding interface
    forAll (topoChanger_, modI)
    {
...
#       include "moveValvePointsThoboisSliding.H"
        movePoints(newPoints);
//        newPoints = points();
        newPoints = allPoints();
        setVirtualPositions();
