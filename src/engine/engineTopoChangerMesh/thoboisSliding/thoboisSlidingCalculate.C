...
void Foam::thoboisSliding::calcMovingMaskTop(const label i) const
{
    if (debug)
    {
...
const Foam::scalarField& Foam::thoboisSliding::movingPointsMaskTop(const label i) const
{
    if(movingPointsMaskTopPtr_)
    {
...
void Foam::thoboisSliding::calcMovingMaskBottom(const label i) const
{
    if (debug)
    {
        Info<< "void movingSquaresTM::calcMovingMasks() const : "
...
// Return moving points mask.  Moving points marked with 1
const Foam::scalarField& Foam::thoboisSliding::movingPointsMaskBottom(const label i) const
{
    if(movingPointsMaskBottomPtr_)
    {
...
void Foam::thoboisSliding::calcMovingMaskPiston() const
{
    if (debug)
    {
        Info<< "void movingSquaresTM::calcMovingMasks() const : "
...
// Return moving points mask.  Moving points marked with 1
const Foam::scalarField& Foam::thoboisSliding::movingPointsMaskPiston() const
{
    if(movingPointsMaskPistonPtr_)
    {
...
void Foam::thoboisSliding::calcMovingMaskPistonValves(const label i) const
{
    if (debug)
    {
        Info<< "void movingSquaresTM::calcMovingMasks() const : "
...
// Return moving points mask.  Moving points marked with 1
const Foam::scalarField& Foam::thoboisSliding::movingPointsMaskPistonValves(const label i) const
{
    if(movingPointsMaskPistonValvesPtr_)
    {
