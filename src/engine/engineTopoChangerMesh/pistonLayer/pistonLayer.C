...
namespace Foam
{
    defineTypeNameAndDebug(pistonLayer, 0);
    addToRunTimeSelectionTable(engineTopoChangerMesh, pistonLayer, IOobject);
}


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::pistonLayer::makeLayersLive()
{
    ...
    forAll (topoChanges, modI)
    {
        ...
        {
            FatalErrorIn("void Foam::pistonLayer::makeLayersLive()")
...
{
    // Does nothing, using the movingWallVelocity boundary condition for U
    // in the piston patch...
