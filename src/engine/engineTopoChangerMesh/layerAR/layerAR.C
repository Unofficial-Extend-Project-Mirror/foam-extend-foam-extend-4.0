// The FOAM Project // File: layerAR.C
/*
-------------------------------------------------------------------------------
...
namespace Foam
{
    ...
    addToRunTimeSelectionTable(engineTopoChangerMesh, layerAR, IOobject);
}
...
void Foam::layerAR::makeLayersLive()
{
    ...
    forAll (topoChanges, modI)
    {
        ...
        {
            FatalErrorIn("void Foam::layerAR::makeLayersLive()")
...
void Foam::layerAR::checkAndCalculate()
{
    label pistonIndex = -1;
...
void Foam::layerAR::setVirtualPistonPosition()
{
    ...
    if (!foundPistonFace)
    {
        FatalErrorIn("Foam::layerAR::setVirtualPistonPosition()")
...
void Foam::layerAR::setBoundaryVelocity(volVectorField& U)
{
