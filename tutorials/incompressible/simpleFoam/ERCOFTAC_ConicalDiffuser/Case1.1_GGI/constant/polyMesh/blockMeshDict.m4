...
// Rotation section A_BB around z-axis
m4_define(sectionA_BB_rotZoffset, calc(15*pi/180.0))

// Rotation section B_F around z-axis
m4_define(sectionB_F_rotZoffset, calc(0*pi/180.0))
...
//Plane BB:
(   0    0 zBB) vlabel(BB0)
( rBB    0 zBB) vlabel(BB1)
(   0  rBB zBB) vlabel(BB2)
(-rBB    0 zBB) vlabel(BB3)
(   0 -rBB zBB) vlabel(BB4)
...
(
    ...
    hex (A0 A2 A3 A0 BB0 BB2 BB3 BB0) ABB
    (rNumberOfCells tNumberOfCells zABnumberOfCells)
    simpleGrading (rGrading 1 1)
    // block2 - negative x and  y 
    hex (A0 A3 A4 A0 BB0 BB3 BB4 BB0) ABB
    (rNumberOfCells tNumberOfCells zABnumberOfCells)
    simpleGrading (rGrading 1 1)
    // block3 - positive x negative y 
    hex (A0 A4 A1 A0 BB0 BB4 BB1 BB0) ABB
    (rNumberOfCells tNumberOfCells zABnumberOfCells)
    simpleGrading (rGrading 1 1)
...
(
    ...
    //Plane BB:
    arc BB1 BB2 ( calc(rBB*sqr)  calc(rBB*sqr) zBB)
    arc BB2 BB3 (-calc(rBB*sqr)  calc(rBB*sqr) zBB)
    arc BB3 BB4 (-calc(rBB*sqr) -calc(rBB*sqr) zBB)
    arc BB4 BB1 ( calc(rBB*sqr) -calc(rBB*sqr) zBB)
