...
#include "orthotropicElasticPlastic.H"
...
namespace Foam
{
    defineTypeNameAndDebug(orthotropicElasticPlastic, 0);
    addToRunTimeSelectionTable
    (
        rheologyLaw, orthotropicElasticPlastic, dictionary
    );
}
...
Foam::orthotropicElasticPlastic::orthotropicElasticPlastic
(
    const word& name,
...
:
    ...
    J_( (1 - nuxy_*nuyx_ - nuyz_*nuzy_ - nuzx_*nuxz_ - 2*nuyx_*nuzy_*nuxz_) / (Ex_*Ey_*Ez_) ),
...
Foam::tmp<Foam::volScalarField> Foam::orthotropicElasticPlastic::rho() const
{
...
Foam::tmp<Foam::volScalarField> Foam::orthotropicElasticPlastic::E() const
{
    tmp<volScalarField> tresult
    (
        new volScalarField
...
Foam::tmp<Foam::volScalarField> Foam::orthotropicElasticPlastic::nu() const
{
    tmp<volScalarField> tresult
    (
        new volScalarField
...
Foam::tmp<Foam::volScalarField> Foam::orthotropicElasticPlastic::Ep() const
{
...
Foam::tmp<Foam::volScalarField> Foam::orthotropicElasticPlastic::sigmaY() const
{
    return tmp<volScalarField>
    (
        new volScalarField
...
Foam::scalar Foam::orthotropicElasticPlastic::sigmaY
(
...
Foam::scalar Foam::orthotropicElasticPlastic::dSigmaY
(
    const scalar epsilonPEq,
    const label cellID
) const
...
//Foam::tmp<Foam::volTensorField> Foam::orthotropicElasticPlastic::K() const
Foam::tmp<Foam::volDiagTensorField> Foam::orthotropicElasticPlastic::K() const
{
...
Foam::tmp<Foam::volSymmTensor4thOrderField> Foam::orthotropicElasticPlastic::C() const
{
