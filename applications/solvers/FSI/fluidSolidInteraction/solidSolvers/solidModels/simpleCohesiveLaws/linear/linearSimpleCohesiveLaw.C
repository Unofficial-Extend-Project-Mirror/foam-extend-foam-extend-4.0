...
namespace Foam
{
    defineTypeNameAndDebug(linearSimpleCohesiveLaw, 0);
...
Foam::linearSimpleCohesiveLaw::linearSimpleCohesiveLaw
(
...
Foam::linearSimpleCohesiveLaw::linearSimpleCohesiveLaw
(
    const linearSimpleCohesiveLaw& lcl
)
:
    simpleCohesiveLaw(lcl),
    deltaC_(lcl.deltaC_)
{}
...
Foam::scalar Foam::linearSimpleCohesiveLaw::traction(scalar delta) const
{
