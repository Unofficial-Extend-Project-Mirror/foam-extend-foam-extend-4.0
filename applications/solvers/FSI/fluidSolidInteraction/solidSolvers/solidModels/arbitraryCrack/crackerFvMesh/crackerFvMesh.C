...
//     }
    ...
    const word crackPatchName(coeffDict_.lookup("crackPatch"));
    ...
    const word openPatchName(coeffDict_.lookup("openPatch"));
...
//     Pout << "globalCrackFaceCentres: " << globalCrackFaceCentres << endl;
//     Pout << "globalCrackFaceSizes: " << globalCrackFaceSizes << endl;
}
...
:
    ...
    topoChangeMap_(),
    crackPatchID_(word(coeffDict_.lookup("crackPatch")), boundaryMesh()),
    regionsPtr_(NULL),
...
bool Foam::crackerFvMesh::update()
{
    ...
    bool changeTopology = fc.changeTopology();
...
// const Foam::label& Foam::crackerFvMesh::test() const
// {
//     return localCrackStart_;
// }
