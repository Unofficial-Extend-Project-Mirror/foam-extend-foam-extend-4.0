...
# PyFoam
# ~~~~~~
if ( $?PYFOAM_SYSTEM == 0 && -e "$WM_THIRD_PARTY_DIR"/packages/PyFoam-0.6.2/platforms/noarch ) then
    _foamSource $WM_THIRD_PARTY_DIR/packages/PyFoam-0.6.2/platforms/noarch/etc/PyFoam-0.6.2.csh
endif
