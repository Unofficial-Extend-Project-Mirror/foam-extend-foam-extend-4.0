...
# Load PyFoam
# ~~~~~~~~~~~
[ -z "$PYFOAM_SYSTEM" ] && [ -e $WM_THIRD_PARTY_DIR/packages/PyFoam-0.6.2/platforms/noarch ] && {
    _foamSource $WM_THIRD_PARTY_DIR/packages/PyFoam-0.6.2/platforms/noarch/etc/PyFoam-0.6.2.sh
}
